...
- Mail app now use AI to predict in which IMAP folder I want to move my emails. It has also got [inbox filtering](http://www.imore.com/how-manage-email-and-mailboxes-mail-app-iphone-and-ipad#filter) and mailing list unsubscribe feature.
...
- Bluetooth bug doesn't let me listen to WhatsApp audio messages with wireless headsets (and maybe it broke [other things](http://www.macrumors.com/2016/09/13/ios-10-bluetooth-le-peripheral-mode-bug/)).
